...
lib.ssMetadata = [
		{name:"SCU_HS_Jan2020_300x250_v3_remarket_atlas_", frames: [[302,136,109,28],[302,0,175,66],[302,166,107,13],[302,68,158,66],[0,0,300,250]]}
];
...
(lib.applynow = function() {
	this.initialize(ss["SCU_HS_Jan2020_300x250_v3_remarket_atlas_"]);
	this.gotoAndStop(0);
...
(lib.SCU_HS_Jan2020_300x250_v3 = function() {
	this.initialize(ss["SCU_HS_Jan2020_300x250_v3_remarket_atlas_"]);
	this.gotoAndStop(4);
}).prototype = p = new cjs.Sprite();
...
(lib.Tween8 = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.instance = new lib.applynow();
...
// stage content:
(lib.SCU_HS_Jan2020_300x250_v3_remarket = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_108 = function() {
		...
		*/
		window.open('https://info.scuhs.edu/msms/?utm_source=google&utm_medium=display&channel=display_retargeting_converge&utm_campaign=1.2020_msms_retargeting_us', '_blank');
		});
		var _this = this;
		/*
	...
	this.instance.setTransform(380.5,225);
	this.instance._off = true;

	this.button_1 = new lib.Symbol2();
	this.button_1.name = "button_1";
	this.button_1.setTransform(222.5,223);
	new cjs.ButtonHelper(this.button_1, 0, 1, 1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance}]},93).to({state:[{t:this.button_1}]},15).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(93).to({_off:false},0).to({_off:true,x:222.5,y:223,mode:"independent"},15).wait(1));
	...
	// background
	this.instance_7 = new lib.SCU_HS_Jan2020_300x250_v3();
...
// library properties:
lib.properties = {
	id: 'F3E124B71DCD4F47AF355D9DA6748084',
	width: 300,
	height: 250,
	fps: 30,
	color: "#FFFFFF",
	opacity: 1.00,
	manifest: [
		{src:"images/SCU_HS_Jan2020_300x250_v3_remarket_atlas_.png", id:"SCU_HS_Jan2020_300x250_v3_remarket_atlas_"}
	],
	preloads: []
};
...
an.compositions['F3E124B71DCD4F47AF355D9DA6748084'] = {
